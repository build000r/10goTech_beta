...
module.exports = __webpack_require__("I6YL");
...
const signout = ({
  ...
  const {
    ...
    method: "post",
    body: {},
    onSuccess: () => next_router__WEBPACK_IMPORTED_MODULE_1___default.a.push(`/${currentUser.userOfSite === "rfp" ? "admin" : "user"}/${currentUser.userOfSite}`)
  });
  Object(react__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(() => {
    doRequest();
  }, []);
  return /*#__PURE__*/Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsxs"])("div", {
    children: ["signing out of ", currentUser.userOfSite]
  });
};
