  ...
  return (
    ...
    >
      ...
      <p class="p4">
        ...
        passing off, rights in designs, rights in computer software, database
        rights, rights to use, in each case whether registered or unregistered
      ...
      <p class="p4">
        ...
        and that you have no rights in, or to, the Software, other than the
      ...
      <p class="p4">
        ...
        parties to exploit the software; or (c) reverse engineer, decompile,
      ...
      <p class="p4">
        ...
        orally designates as &ldquo;Confidential&rdquo; at the time of
        disclosure; (c) the nonpublic features and functions of the Software,
        for which 10goTech is Discloser; and (d) any other nonpublic, sensitive
        information Recipient should reasonably consider a trade secret or
        otherwise confidential. Notwithstanding the foregoing, Confidential
        Information does not include information that: (i) is in
        Recipient&rsquo;s possession at the time of disclosure; (ii) becomes
        know publicly, before or after disclosure, other than as a result of
      ...
      <p class="p4">
        ...
        Information to any employee or contractor or Recipient unless such
        person needs access in order to facilitate the Purpose and executes a
        nondisclosure agreement with Recipient with terms no less restrictive
        that those of this Article 4; and (b) shall not disclose Confidential
        Information to any other third party without Discloser&rsquo;s prior
        written consent. Without limiting the generality of the foregoing,
        Recipient shall protect Confidential Information with the same degree of
        care it uses to protect its own confidential information of similar
        nature and importance, but with no less than reasonable care. Recipient
        shall promptly notify Discloser of and misuse or misappropriation of
        confidential Information that comes to Recipient&rsquo;s attention.
        Notwithstanding the foregoing, Recipient may disclose Confidential
        Information as required by applicable law or by proper legal or
        governmental authority. Recipient shall give Discloser prompt notice of
      ...
      <p class="p4">
        ...
        and documentation and other material on, in, or made available through
        the Products, as well as the selection, coordination, arrangement,
        organization, and enhancement of the Product Materials. All Product
        Materials are protected pursuant to copyright, trademark, patent, and
        other applicable laws. As between any User and 10goTech, all names,
        trademarks, service marks, certification marks, symbols, slogans, or
        logos (&ldquo;<strong>Trademarks</strong>&rdquo;) appearing on the
        Products are proprietary to 10goTech or its affiliates, licensors, or
        suppliers. Use or misuse of these Trademarks is expressly prohibited and
        may violate federal trademark law. Unless expressly written otherwise by
      ...
      <p class="p4">
        ...
        to automatically charge your payment method(s) every month until you
      ...
      <p class="p4">
        ...
        to you. 10goTech may permanently delete or erase your content or suspend
      ...
      <p class="p4">
        ...
        WARRANT THAT THE SYSTEM WILL PREFORM WITHOUT INTERRUPTION OR ERROR; (c)
        10GOTECH DOES NOT REPRESENT OR WARRANT THAT THE SYSTEM IS SECURE FROM
      ...
      <p class="p4">
        ...
        risks. 10goTech offers no representation, warranty, or guarantee that
      ...
      <p class="p4">
        ...
        Information is collected, accessed, used, stored, processed, disposed of
      ...
      <p class="p4">
        ...
        offers no representation, warranty, or guarantee that your content will
      ...
      <p class="p4">
        ...
        professionals or their officers, employees, directors, parents,
      ...
      <ul class="ul1">
        <ol class="ol2">
          <li class="li4">
            ...
            &ndash; is where an attacker essentially floods a target server with
            traffic in an attempt to disrupt, and perhaps even bring down the
            target. A DDoS attack is able to leverage multiple compromised
            devices to bombard the target with traffic.
          </li>
        </ol>
      </ul>
      <p class="p2">
      ...
      <ul class="ul1">
        <ol class="ol2">
          <li class="li4">
            ...
            organizations who are using that software in order to exploit the
            vulnerability before a fix becomes available.
          </li>
        </ol>
      </ul>
      <p class="p2">
      ...
      <ul class="ul1">
        <ol class="ol2">
          <li class="li4">
            ...
            queries. The malware is used to create a persistent communication
            channel that most firewalls are unable to detect.
          </li>
        </ol>
      </ul>
      <p class="p2">
      ...
      <ul class="ul1">
        <ol class="ol2">
          <li class="li4">
            ...
            into transferring money into an account controlled by the attacker.
            BEC attacks usually involve planning and research in order to be
            effective.
          </li>
        </ol>
      </ul>
      ...
      <ul class="ul1">
        <ol class="ol2">
          <li class="li4">
            ...
            one that is directly controlled by the attacker, or one that has
            been compromised. In some cases, the malware is served in content
            such as banners and advertisements.
          </li>
        </ol>
      </ul>
      <p class="p2">
      ...
      <ul class="ul1">
        <ol class="ol2">
          <li class="li4">
            ...
            typically used to infect other users who visit the site. It can
            happen on the comment section on a webpage.
          </li>
        </ol>
      </ul>
      <p class="p2">
      ...
      <ul class="ul1">
        <ol class="ol2">
          <li class="li4">
            ...
            attack, Credential stuffing, Password spraying and Keylogger attack.
          </li>
        </ol>
      </ul>
      <p class="p2">
      ...
      <ul class="ul1">
        <ol class="ol2">
          <li class="li4">
            ...
            communications to intercept and access data that is being sent
            across the network.
          </li>
        </ol>
      </ul>
      ...
      <ul class="ul1">
        <ol class="ol2">
          <li class="li4">
            ...
            accordingly. They can use intelligence feeds to quickly identify
            software vulnerabilities, as well as scan systems themselves for
            potential vulnerabilities. AI-powered attacks can work around the
            clock, they are fast, efficient, affordable and adaptable.
          </li>
        </ol>
      </ul>
      <p class="p2">
      ...
      <ul class="ul1">
        <ol class="ol2">
          <li class="li4">
            ...
            in order to launch large-scale DDoS attacks.
          </li>
        </ol>
      </ul>
      <p class="p2">
      ...
      <p class="p4">
        ...
        or remove hosted content, remove any special status associated with the
      ...
      <p class="p4">
        ...
        &ldquo;Indemnify Claim&rdquo;, meaning any third-party claim, suit, or
        proceeding arising out of, related to, or alleging: (a) infringement or
        violation of third party intellectual property, privacy or publicity
        rights by content submitted to or transmitted through the System from
        your account, including without limitation by your content; and (b)
        claims that use of the System through your account harasses, defames, or
        defrauds a third party, infringe, or misappropriates, copyright, trade
        secret, or other intellectual property rights, or violates the CAN-Spam
        Act Compliance or any other law or restriction on electronic
        advertising. 10goTech will have the right, not to be exercised
      ...
      <p class="p4">
        ...
        the Service or any part thereof; (d) a request and/or order of law
        enforcement, a judicial body, or other government agency; (e) provision
        of the 10goTech Services to you becoming unlawful; (f) unexpected
        technical or security issues or problems; or (g) your participation in
        fraudulent or illegal activities. Any such termination or suspension
        shall be made by us in our sole discretion, without any refund to you of
      ...
      <p class="p4">
        ...
        termination; (b) Articles and Sections 3.2 (Restrictions on Software
        Rights), 4 (Confidential Information), 4.1 (Nondisclosure), 5 (Property
        Rights), 13 (Disclaimer of Liability), 14 (Disclaimer of Warranties), 21
