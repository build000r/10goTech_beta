...
import { SiteDeletedListener } from "./events/listeners/site-deleted-listener";
...
const start = async () => {
  ...
  try {
    ...
    new SiteDeletedListener(natsWrapper.client).listen();

    await mongoose.connect(
      process.env.MONGO_URI + "/site-subscription?retryWrites=true&w=majority",
      {
