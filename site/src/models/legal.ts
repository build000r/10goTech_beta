export const pp = `10goTech is committed to protecting your privacy. It governs the Privacy Terms of our Platform, located at https://www.10gotech.com This Privacy Policy explains how your personal information is collected, used, and disclosed by our Company.
...
10goTech legal basis for collecting and using the personal information described in this Platform Agreement depends on the Personal Data we collect and the specific context in which we collect it.
10goTech may process your Personal Data because:
...
You have certain data protection rights. 10goTech aims to take reasonable steps to allow you to correct, amend, delete, or limit the use of your Personal Data.
...
The right to withdraw consent. You also have the right to withdraw your consent at any time where the 10goTech relied on your consent to process your personal information.
...
export const ua = `
10gotech LLC doing business as 10goTech (“we or “10goTech” or “Company”) provides Digital products & consulting (“web-application” or “System”) for use by you (“User”). 

By accessing, downloading, and/or using 10goTech and/or the Services, you agree to this User Agreement (“Agreement”). THESE USER TERMS CREATE A BINDING LEGAL AGREEMENT BETWEEN YOU AND 10goTech, 10goTech and customers of 10gotech PLEASE READ THEM CAREFULLY. IF YOU DO NOT AGREE WITH ANY OF THESE TERMS, YOU SHOULD NOT ACCESS, DOWNLOAD, and/or use our website/service/app.

10goTech reserves the right to modify these Terms at any time by email or posting a notice on the Platform. Your access to the Platform after the notice is posted indicates acceptance of those changes.

Definitions

When the following words are used in these Terms, this is what they will mean:

Company: When this terms mention “Company,” “we,” “us,” or “our,” it refers to 10goTech that is responsible for the information under this Agreement.
Software: The online software applications provided by 10goTech as part of the Services.
User: Means the customer, person, company, or organisation who purchases Subscription Service from 10goTech Platform.
License Fee: The subscription licence fee payable by the User to 10goTech as set out in this Agreement.
...
Notification: The email/push sent from 10goTech to a User.
...
(a) Infringes or violates the intellectual property rights or any other rights of anyone else (including 10goTech);
(b) Violates any law, international law, including, without limitation, any applicable export control laws;
(c) Is harmful, fraudulent, deceptive, threatening, harassing, defamatory, obscene, or otherwise objectionable;
(d) Jeopardizes the security of your 10goTech account or anyone else’s (such as allowing someone else to log in to the Services as you);
...
As between You and 10goTech, we own or license all data, content, graphics, audio clips, video clips, presentations, forms, artwork, images, photographs, functional components, and any software concepts and documentation and other material on, in, or made available through the Products, as well as the selection, coordination, arrangement, organization, and enhancement of the Product Materials. All Product Materials are protected pursuant to copyright, trademark, patent, and other applicable laws. As between any User and 10goTech, all names, trademarks, service marks, certification marks, symbols, slogans, or logos (“Trademarks”) appearing on the Products are proprietary to 10goTech or its affiliates, licensors, or suppliers. Use or misuse of these Trademarks is expressly prohibited and may violate federal trademark law. Unless expressly written otherwise by 10goTech, You have the right to use the Product Materials in accordance with these Terms.
...
If 10goTech suspects that you have violated the requirements of this section, we may suspend your access to the System without advanced notice, in addition to other remedies we may have. 

10goTech is not obligated to take any action against you or any other System user or other third party for violating this Agreement, but we are free to take any such action it sees fit.
...
You agree to take reasonable steps to prevent unauthorized access to the System, including by protecting your password and other log-in information. You shall notify 10goTech immediately if you know of or suspect unauthorized use of the System or breach of its security. 
...
10goTech is not liable, and you agree not to hold us (owners, founder, co-founders, executive team, employees, subsidiaries, affiliates, agents) responsible for any: DAMAGES FOR LOSS OF REVENUES, PROFITS, GOODWILL, USE, DATA OR OTHER INTANGIBLE LOSSES ARISING OUT OF OR RELATED TO YOUR USE OF THE SITE OR THE SERVICES, REGARDLESS OF WHETHER SUCH DAMAGES ARE BASED ON CONTRACT, TORT (INCLUDING NEGLIGENCE AND STRICT LIABILITY), WARRANTY, STATUTE OR OTHERWISE.

Disclaimer of Warranties

10goTech disclaims all warranties, express or implied regard to this service. 10goTech does not make representations of any kind or warranties available to you through the Platform.  
No oral advice or written information given by 10goTech or any of its affiliates, employees, officers, directors, agents, or the like will create a warranty.
WITHOUT LIMITATING THE GENERALITY OF THE FOREGOING: (a) 10GOTECH HAS NO OBLIGATION TO INDEMNIFY OR DEFEND YOU AGAINST CLAIMS RELATED TO INFRINGMENT OF INTELLECTUAL PROPERTY; (b) 10GOTECH DOES NOT REPRESENT OR WARRANT THAT THE SYSTEM WILL PREFORM WITHOUT INTERRUPTION OR ERROR; (c) 10GOTECH DOES NOT REPRESENT OR WARRANT THAT THE SYSTEM IS SECURE FROM HACKING OR OTHER UNAUTHORIZED INTRUSION OR THAT YOUR CONTENT WILL REMAIN PRIVATE OR SECURE; AND (d) 10GOTECH DISCLAIMS ANY REPRESENTATION OR WARRANTY CONCERNING PRODUCTS OR SERVICES PROVIDED BY OTHER USERS OF THE SYSTEM OR OTHER THIRD PARTIES. 
...
10goTech is not liable, and you agree not to hold us responsible for any damages or losses arising out of or in connection with this Agreement, including, but not limited to:
...
10goTech strives to protect Customers against Cyberattacks. We have implemented our system with security experts; we take different types of security measures, but the Internet environment is a 24/7 risky and vulnerable.

We are not liable for any Cyberattack, damage, or loss on the World Wide Web. You expressly agree and acknowledge that the use of the 10goTech Platform is at your sole risk. In no event will 10goTech, 10goTech professionals or their officers, employees, directors, parents, subsidiaries, affiliates, agents or licensors be liable for any indirect, incidental, special, consequential or exemplary damages, including but not limited to, damages for loss of revenues, profits, goodwill, use data or other intangible losses arising out of or related to your use of the site or the services.
...
If you are from The United States, The United Kingdom or European Economic Area (EEA), 10goTech legal basis for collecting and using the personal information described in this Platform Agreement depends on the Personal Data we collect and the specific context in which we collect it.
...
we think that such restrictions will improve the security of the 10goTech community or reduce our or another 10goTech user's exposure to financial liabilities;
...
You agree to defend, indemnify, and hold harmless 10goTech and the 10goTech Associates, officers, directors, shareholders, parents, subsidiaries, agents, successors, and assigns, against any “Indemnify Claim”, meaning any third-party claim, suit, or proceeding arising out of, related to, or alleging: (a) infringement or violation of third party intellectual property, privacy or publicity rights by content submitted to or transmitted through the System from your account, including without limitation by your content; and (b) claims that use of the System through your account harasses, defames, or defrauds a third party, infringe, or misappropriates, copyright, trade secret, or other intellectual property rights, or violates the CAN-Spam Act Compliance or any other law or restriction on electronic advertising. 10goTech will have the right, not to be exercised unreasonably, to reject any settlement or compromise that requires that it admit wrongdoing or liability or subjects it to any ongoing affirmative obligations. 

In no event shall 10goTech, its employees, agents, and sub-contractors be liable to the Customer to the extent that the alleged infringement is based on:

A modification of the Services or Documentation by anyone other than 10goTech, unless approved in writing by 10goTech; or
A combination of the Software with software or products not supplied or approved in writing by 10goTech;
The Customer's use of the Services or Documentation in a manner contrary to the instructions given to the Customer by 10goTech; or
The Customer's use of the Services or Documentation after notice of the alleged or actual infringement from 10goTech or any appropriate authority.
